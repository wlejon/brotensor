...
extern "C" void brotensor_probe_and_register_metal() {
    ...
    ops.flash_attention_gqa_forward                 = &dm::flash_attention_gqa_forward;
    ...
    ops.interp2d_align_corners_forward              = &dm::interp2d_align_corners_forward;
    ...
    ops.masked_diffusion_scores                     = &dm::masked_diffusion_scores;
    ops.masked_diffusion_commit                     = &dm::masked_diffusion_commit;
